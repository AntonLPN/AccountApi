...
public class UserLoginSagaDefinition : SagaDefinition<UserLoginSagaState>
{
    public UserLoginSagaDefinition()
    {
        EndpointName = "user-login-saga";
    }

    protected override void ConfigureSaga(
        IReceiveEndpointConfigurator endpointConfigurator,
        ISagaConfigurator<UserLoginSagaState> sagaConfigurator,
